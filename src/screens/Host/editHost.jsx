...
export default function EditHost() {
  ...
  const [BusinessID, setBusinessID] = useState('HST-12345');
  ...
  return (
    <React.Fragment>
      <div className="d-flex flex-wrap align-items-center justify-content-between mb_20">
        <h4 className="mainheading">Edit Host</h4>
        <div className="d-inline-flex align-items-center gap-3">
          <Button className="btn-sm" variant="outline-primary" as={Link} to='/host'><Icon icon="ic:outline-arrow-back" width={22} height={22} />Back</Button>
          ...
          <Row className="g-3">
            ...
            <Col md={6}>
              <Form.Group className="form-group">
                ...
                <div className="position-relative">
                  <Form.Select defaultValue='Individual'>
                    <option value='Select'>Select Host Type</option>
            ...
            <Col md={6}>
              <Form.Group className="form-group">
                ...
                <Form.Control type="text" placeholder="Enter business ID" value={BusinessID} onChange={e => setBusinessID(e.target.value)}/>
              </Form.Group>
            </Col>
            <Col md={6}>
              <Form.Group className="form-group">
            ...
            <Col md={12}>
              <Form.Group className="form-group">
                <Form.Label>Documents Upload (ID, Proof of Address)</Form.Label>
