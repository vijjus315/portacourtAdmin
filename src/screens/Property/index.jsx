...
export default function Property() {
                ...
                <Popover id={`popover-actions-${row.id}`} className="popoverdropdown">
                  ...
                  >
                    <div className="d-flex flex-column">
                      ...
                      <Button variant="link" as={Link} className="dropdownitem" to='/property/editproperty'><Icon icon="mynaui:edit" width={16} height={16} className="me-1"/>Edit</Button>
  ...
  const data = [
      {
        id: 1, img: img1, name: 'Luxury Beach Villa', Host: 'John Doe', Location: 'Miami, FL', Amount: '$2250', Rating: '4.5', Status: 'Published',
      },
      {
        id: 2, img: img2, name: 'Downtown Loft', Host: 'Jane Smith', Location: 'New York, NY', Amount: '$1120', Rating: '4.0', Status: 'Published',
      },
      {
        id: 3, img: img3, name: 'Mountain Cabin', Host: 'Michael Johnson', Location: 'Aspen, CO', Amount: '$1600', Rating: '4.2', Status: 'Unpublished',
      },
      {
        id: 4, img: img4, name: 'City Center Apartment', Host: 'Emily Davis', Location: 'San Francisco, CA', Amount: '$390', Rating: '4.8', Status: 'Published',
      },
      {
        id: 5, img: img1, name: 'Luxury Beach Villa', Host: 'John Doe', Location: 'Miami, FL', Amount: '$2250', Rating: '4.5', Status: 'Published',
      },
      {
        id: 6, img: img2, name: 'Downtown Loft', Host: 'Jane Smith', Location: 'New York, NY', Amount: '$1120', Rating: '4.0', Status: 'Published',
      },
      {
        id: 7, img: img3, name: 'Mountain Cabin', Host: 'Michael Johnson', Location: 'Aspen, CO', Amount: '$1600', Rating: '4.2', Status: 'Unpublished',
      },
      {
        id: 8, img: img4, name: 'Luxury Beach Villa', Host: 'John Doe', Location: 'Miami, FL', Amount: '$2250', Rating: '4.5', Status: 'Published',
      },
      {
        id: 9, img: img1, name: 'Downtown Loft', Host: 'Jane Smith', Location: 'New York, NY', Amount: '$1120', Rating: '4.0', Status: 'Published',
      },
  ]
  ...
  return (
    <React.Fragment>
      <div className="d-flex flex-wrap align-items-center justify-content-between mb_20">
        <h4 className="mainheading">Properties</h4>
        <Button as={Link} className="btn-sm" to='/property/addproperty'><Icon icon="ic:twotone-plus" width={22} height={22} />Add Property</Button>
      </div>
